...
Route::post('/update/change/password', [IndexController::class, 'UserStorePassword'])
...
Route::get('/language/vi', [LanguageController::class, 'Vietnamese'])->name('vi.language');
