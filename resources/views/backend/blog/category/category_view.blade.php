                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($blogcategory as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('blog.category.edit',$item->id) }}" class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i> </a>                                                <a href="{{ route('category.delete',$item->id) }}" class="btn btn-danger" title="Delete Data" id="delete">
