                ...
                <div class="col-8">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sub->SubCategory List <span class="badge badge-pill badge-danger"> {{ count($subsubcategory) }} </span></h3>                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="table-responsive">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="subsubcategory_name_vi" class="form-control" >
