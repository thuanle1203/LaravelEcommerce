                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="#"><i class="icon fa fa-user"></i>
                                @if(session()->get('language') == 'vi') Tài Khoản @else My Account @endif
                            </a>
                        </li>
                        <li>
                ...
                <div class="cnt-block">
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                                <span class="value">
                                    @if(session()->get('language') == 'vi') Ngôn ngữ @else Language @endif
                                </span>
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                @else
                                    <li>
                                        <a href="{{ route('vi.language') }}">Vietnamese</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
    ...
    <div class="main-header">
        <div class="container">
            <div class="row">
                ...
                <!-- ============================================================= LOGO ============================================================= -->
                    <div class="logo"> <a href="{{ url('/') }}"> <img src="{{ asset($setting->logo) }}" alt="logo"> </a> </div>                    <!-- Logo -->
                    <!-- ============================================================= LOGO : END ============================================================= -->
                </div>
                <!-- Logo-holder -->
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu" >
                                            ...
                                            <li role="presentation">
                                                <a role="menuitem" tabindex="-1" href="">- Clothing</a>
                                            </li>
                                            <li role="presentation">
                                                <a role="menuitem" tabindex="-1" href="">- Electronics</a>
                                            </li>
                                            <li role="presentation">
                                                <a role="menuitem" tabindex="-1" href="">- Shoes</a>
                                            </li>
                                            <li role="presentation">
                                                <a role="menuitem" tabindex="-1" href="">- Watches</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                                ...
                                <li class="active dropdown yamm-fw">
                                    <a href="{{ url('/') }}" data-hover="dropdown"
                                       class="dropdown-toggle" data-toggle="dropdown">
                                        @if(session()->get('language') == 'vi') Trang Chủ @else Home @endif
                                    </a>
                                </li>
                                                                    ...
                                                                    <ul class="links">
                                                                        <li>
                                                                            <a href="{{ url('subsubcategory/product/'.$subsubcategory->id.'/'.$subsubcategory->subsubcategory_slug_en ) }}">
                                                                                @if(session()->get('language') == 'vi')
                                                                                    {{ $subsubcategory->subsubcategory_name_vi }}
                                                                                @else
